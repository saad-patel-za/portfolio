...
export const skills = [
  ...
  {title:'Code & interaction',detail:'From the first Figma frame to the final interaction.',items:['HTML','CSS','JavaScript','PHP','React.js','jQuery','Tailwind','Bootstrap','GSAP','Locomotive.js']},
  {title:'Connected systems',detail:'The integrations and infrastructure behind the experience.',items:['Make.com','Klaviyo','cPanel','MySQL']},
];
export const credentials = ['36KR4BFG3VB4','T8XCGCDX6D2S','RSYNZWC8VMK8','U3P9Z684UEQT'];
